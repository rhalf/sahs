    ...
    <v-row>
      <v-col>
        <v-row class="px-3 py-2">
          ...
          <v-col>
            <v-chip class="v-chip--active announcement white--text caption" v-text="`announcement`"></v-chip>
            <v-chip class="v-chip--active article white--text caption" v-text="`article`"></v-chip>
            <v-chip class="v-chip--active question white--text caption" v-text="`question`"></v-chip>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col>
        <v-card  
          v-for="post in posts"
          :key="post.id"
          :class="`${post.type} pa-1 ma-1 grey lighten-4`" >
          <v-row >
            <v-col >
            ...
            <v-col>
              ...
              <PostDialogEdit :method="queryAll" :post="post" :snackbar="snackbar"></PostDialogEdit>
              <PostDialogRemove :method="queryAll" :post="post" :snackbar="snackbar"></PostDialogRemove>
              </v-row>
            </v-col>
          </v-row>
        </v-card>
...
export default {
  ...
  components: { PostDialogView, PostDialogAdd, PostDialogRemove, PostDialogEdit  },
  data() {
    return {
      reveal: false,
      posts : [],
